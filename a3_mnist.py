...
# Rename Lenet to My_MNIST as required by the assignment
class My_MNIST(nn.Module):
    """
    Target model for MNIST digit classification
    Modified LeNet architecture with dropout for regularization
    """
    def __init__(self):
...
if __name__ == "__main__":
    ...
    # Save the model as target_model.pth as required by the assignment
    torch.save(model.state_dict(), "target_model.pth")
    print("Model saved as target_model.pth")